...
def test_popup_notification(driver):
    ...
    assert home_page.validate_notification() == True, "Notification was not displayed."
    assert home_page.validate_notification_text() == "This is the notification subtitle"